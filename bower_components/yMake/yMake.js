...
var yMake = (function($$) {
    ...
    $$.an.mark = function(attr) {
        ...
        function tab() {
            ...
            if (now == 0) {
                $$.an.startMove(oSmallUl, {
                    left: 0
                }, 1);
            } else if (now == aSmallLi.length - 1) {
                $$.an.startMove(oSmallUl, {
                    left: -(now - 2) * (aSmallLi[0].offsetWidth + 10)
                }, 1);
            } else {
                $$.an.startMove(oSmallUl, {
                    left: -(now - 1) * (aSmallLi[0].offsetWidth + 10)
                }, 1);
            }
        };
